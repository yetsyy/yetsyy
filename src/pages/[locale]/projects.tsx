...
const projects = [
  {
    ...
    image: 'https://placehold.co/600x400/1a202c/ffffff?text=Aprendizaje+No+Supervisado',
  },
  {
    title: 'NLP con BERT',
    description: 'nlp_with_bert_description',
    link: 'https://github.com/yetsyy/nlp_with_bert',
    image: 'https://placehold.co/600x400/1a202c/ffffff?text=NLP+con+BERT',
  },
  {
    ...
    image: 'https://placehold.co/600x400/1a202c/ffffff?text=Interpretability+de+Modelos',
  },
  {
    ...
    image: 'https://placehold.co/600x400/1a202c/ffffff?text=Clasificación+de+Imágenes',
  },
  {
    ...
    image: 'https://placehold.co/600x400/1a202c/ffffff?text=Optimización+de+Hiperparámetros',
  },
  {
    ...
    image: 'https://placehold.co/600x400/1a202c/ffffff?text=Clasificación+con+XGBoost',
  },
  {
    title: 'API con Docker',
    description: 'docker_api_description',
    link: 'https://github.com/yetsyy/sesion2_docker_api',
    image: 'https://placehold.co/600x400/1a202c/ffffff?text=API+con+Docker',
  },
  {
    title: 'Proyecto en R',
    description: 'r_project_description',
    link: 'https://github.com/yetsyy/Proyecto_2',
    image: 'https://placehold.co/600x400/1a202c/ffffff?text=Proyecto+en+R',
  },
];
        ...
        {projects.map((project, index) => (
          <div key={index} className="bg-gray-800 rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
            ...
            <div className="p-6">
              ...
              <a href={project.link} className="inline-block bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full transition-colors duration-300 flex items-center justify-center">
